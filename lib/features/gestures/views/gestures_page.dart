    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Thử tap, double tap, và long press vào box dưới đây:'),
          ...
          GestureDetector(
            ...
            onTapCancel: () => setState(() => _gestureStatus = 'Tap Cancelled'),
            onDoubleTap: () => setState(() => _gestureStatus = 'Double Tapped'),
            onLongPress: () => setState(() => _gestureStatus = 'Long Pressed'),
            onLongPressStart:
                (details) =>
          ...
          const Text('Dùng 2 ngón tay để thu phóng và xoay:'),
          const SizedBox(height: 10),
          GestureDetector(
          ...
          const Text('Kéo theo chiều ngang/dọc:'),
          const SizedBox(height: 10),
          Container(
            height: 150,
          ...
          Text('4. Pan Gesture', style: Theme.of(context).textTheme.titleLarge),
          const Text('Kéo theo mọi hướng (pan):'),
          const SizedBox(height: 10),
          GestureDetector(
            onPanStart: (details) {
              setState(() {
            ...
            onPanEnd: (details) {
              setState(() {
                _gestureStatus = 'Pan Ended with velocity: ${details.velocity}';
              });
            },
            child: Container(
              height: 150,
          ...
          // 5. Force Press (iOS)
          Text('5. Force Press', style: Theme.of(context).textTheme.titleLarge),
          const Text('Nhấn mạnh (chỉ hoạt động trên iOS):'),
          const SizedBox(height: 10),
          GestureDetector(
